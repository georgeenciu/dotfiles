...
_G.packer_plugins = {
  ...
  ["nvim-autopairs"] = {
    loaded = true,
    path = "/home/george/.local/share/nvim/site/pack/packer/start/nvim-autopairs",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/george/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["project.nvim"] = {
    loaded = true,
    path = "/home/george/.local/share/nvim/site/pack/packer/start/project.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/george/.local/share/nvim/site/pack/packer/start/vim-bbye",
